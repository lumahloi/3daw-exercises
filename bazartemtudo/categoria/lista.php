...
<body>
    ...
    <div class="modal fade" id="modalDelecao" tabindex="-1" aria-labelledby="modalDelecaoLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalDelecaoLabel">Deletar Categoria</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <input type="hidden" id="idCategoriaParaDeletar" />
                        <label for="descricaoParaDeletar" class="col-form-label">Tem certeza que deseja deletar esta categoria?</label>
                    </div>

                </div>
                <div class="modal-footer">
                    <button id="deletar" type="button" class="btn btn-primary" data-bs-dismiss="modal">Deletar</button>
                    <button type="button" class="btn" data-bs-dismiss="modal">Cancelar</button>
                </div>
            </div>
        </div>
